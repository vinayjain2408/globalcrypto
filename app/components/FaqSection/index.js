...
//           <h3 className=" font-semibold text-lg">Subscribe for Newsletter</h3>

//           <button className="bg-[#FFFFFF] transition-all px-5 py-1 rounded-xl text-[#4965D2] font-medium">
//             Subscribe
//           </button>
//         </div>
//       </div>
...
export default function FaqSection() {
  // state for managing the open FAQ item
  const [openIndex, setOpenIndex] = useState(0);
  ...
  // Handler for the subscribe button (you'll add actual subscription logic here)
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] flex flex-col justify-center items-center px-4 py-10 text-[#4965D2]">
      <div className="max-w-2xl w-full">
        ...
        {/* Email Subscription Box Section (Updated) */}
        {/* We keep the original styling for the container, but replace the button with the form elements */}
        <div className="text-[#FFFFFF] text-center mt-10 rounded-xl px-8 py-8 border border-[#4965D2] border bg-[#4965D2] ">
          <div className="flex justify-center mb-3">
            <img
              src="https://randomuser.me/api/portraits/men/32.jpg"
              alt="user1"
          ...
          <input
            ...
            className="w-full p-2 mb-4 rounded-xl text-[#4965D2] text-center placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white"
          />

          {/* Subscribe Button */}
          <button
            onClick={handleSubscribe}
            className="bg-[#FFFFFF] transition-all px-8 py-2 rounded-xl text-[#4965D2] font-semibold hover:bg-gray-100"
          >
            Subscribe
          </button>
        </div>
